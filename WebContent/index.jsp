...
<html>
<head>
<link rel="stylesheet" type="text/css" href="/CurrencyConverterProject/css/styles.css">  
...
<h1>CurrencyConverter</h1>
 ...
 <form action="/CurrencyConverterProject/ProjectServlet" method="post">
 <input type="submit" name="action" value="Refresh" size="20">
...
<br><br>
<center>
<input type="submit" name="action" value="convert" size="20"/>
<br><br>
</center>   
   <center>
   ...
   <a href="/CurrencyConverterProject/history.jsp" style="color:white">History</a>
  </form> 
</body>
</html>